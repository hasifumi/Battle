...
(function() {
  var BattleEngine, BattleScene, BattleTest, Charactor, RoundFrame, SelectDialog, UtilFunc, UtilWindow,
  ...
  BattleScene = (function(_super) {
    ...
    function BattleScene() {
      var ctx, func, lblAttack, lines, sd1, sp, sur, uw1,
        _this = this;
  ...
  SelectDialog = (function(_super) {
    ...
    SelectDialog.prototype.detectIndex = function(e) {
      ...
      x = e.x - this.x;
      y = e.y - this.y;
      console.log("e.y:" + Math.floor(e.y) + ", y:" + Math.floor(y) + ", y/@DEFAULT.LINE_HEIGHT:" + Math.floor(y / this.DEFAULT.LINE_HEIGHT));
      ...
      index = Math.floor((y - this.DEFAULT.BORDER - this.DEFAULT.PADDING) / this.DEFAULT.LINE_HEIGHT) + 1;
  ...
  RoundFrame = (function(_super) {
    ...
    function RoundFrame(w, h) {
      this.resetSize = __bind(this.resetSize, this);
      this.resetSize(w, h);
    }

    RoundFrame.prototype.resetSize = function(w, h) {
      this.width = w;
      this.height = h;
      this.sur = new Surface(w, h);
      this.ctx = this.sur.context;
    ...
    RoundFrame.prototype.clearText = function(method) {
      var rad;
      this.ctx.fillStyle = this.DEFAULT.BACKGROUND_COLOR;
      rad = this.DEFAULT.RADIUS;
      this.ctx.beginPath();
      this.ctx.moveTo(rad, 0);
      this.ctx.lineTo(this.width - rad, 0);
      this.ctx.arc(this.width - rad, 0 + rad, rad, Math.PI * 1.5, 0, false);
      this.ctx.lineTo(this.width, this.height - rad);
      this.ctx.arc(this.width - rad, this.height - rad, rad, 0, Math.PI * 0.5, false);
      this.ctx.lineTo(rad, this.height);
      this.ctx.arc(rad, this.height - rad, rad, Math.PI * 0.5, Math.PI, false);
      this.ctx.lineTo(0, this.height);
      this.ctx.arc(0, rad, rad, Math.PI, Math.PI * 1.5, false);
      this.ctx.closePath();
      switch (method) {
        case "fill":
          this.ctx.fill();
